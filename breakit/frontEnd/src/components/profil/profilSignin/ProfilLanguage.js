        ...
        return(
            <div className="containerUserProfil">
                ...
                <div className="containerChoicel4">
                    <form className="form">
                        <p> <button className="Spec_button" onClick={() => this.handleClick("JS")} type="button" id="userFront-button">JS</button> </p>
                        <p> <button className="Spec_button" onClick={() => this.handleClick("HTML")} type="button" id="userBack-button">HTML</button> </p>
                        <p> <button className="Spec_button" onClick={() => this.handleClick("CSS")} type="button" id="userFullStack-button">CSS</button> </p>
                    </form>
                </div>
